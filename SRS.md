...
<br>|  Actors	   |  <br>|  
 --- | --- | --- | 
  <br>|  Developers: |What is the goal of these project?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What problem does it solve?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |Who will use it?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What should the software program do?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What is the domain we need to understand?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What are the specifics feature will it need to have?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |Which platforms do you need it to be available on?	   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What other parties integrate with the software program?   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What technologies will be used?   |
  <br>|  Laboratory Director: |`Q&A`	   |
  <br>|  Developers: |What’s the timeline for product development?   |
  <br>|  Laboratory Director: |`Q&A`	   |

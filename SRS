...
##Scope
   ...
   b)Description of Program:
      1.The pruduct will be software interface in local domain.
...
##Overall Description
  a)Product Perspective
    ...
    *external entities 
    *system interfaces will be easy to follow
    ---- diagram-----
  b)Product Functions
    *Log and submit time spent on services
    *Manage leave time
    *Generate, print and export report
    *Employee management
    *Time approval and rejection with notification
    *Time/Student Management
